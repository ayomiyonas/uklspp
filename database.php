...
class Database{
	...
	**/
	...
	function input_spp($angkatan,$tahun,$nominal){
	 mysqli_query($this->koneksi,"insert into spp values('','$angkatan','$tahun','$nominal')");
 	}
	
	function input_kelas($namakelas,$jurusan,$angkatan){
	 mysqli_query($this->koneksi,"insert into kelas values('','$namakelas','$jurusan','$angkatan')");
	 }
	...
	**/	 
	...
	Fungsi Update Data 
	**/
	function update_spp($id, $angkatan, $tahun, $nominal){
		mysqli_query($this->koneksi,"update spp set angkatan='$angkatan',tahun='$tahun', nominal='$nominal' where id_spp='$id'");
	}
	
	function update_kelas($id, $nama, $jurusan, $angkatan){
		mysqli_query($this->koneksi,"update kelas set nama_kelas='$nama', jurusan='$jurusan',angkatan='$angkatan' where id_kelas='$id'");
	}
