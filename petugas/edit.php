              ...
              <form class="form-horizontal" action="proses.php" method="post">
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="angkatan" class="form-control" value="<?php echo $d['angkatan']; ?>"  >
                    </div>
                  </div>
                  <div class="form-group row">
   	...
   	<div class="card card-info">
              ...
              <form class="form-horizontal" action="proses.php" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputEmail3" value="P-<?php echo $d['nis']; ?>" disabled>
