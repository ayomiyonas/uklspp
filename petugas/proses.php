...
//Proses Tambah data
 if($aksi == "tambahspp"){
 	$db->input_spp($_POST['angkatan'],$_POST['tahun'],$_POST['nominal']);
 	header("location:index.php?hal=spp");
 }else if($aksi == "tambahkelas"){
 	$db->input_kelas($_POST['namakelas'],$_POST['jurusan'],$_POST['angkatan']);
 ...
 elseif($aksi == "update_spp"){
 	$db->update_spp($_POST['id'],$_POST['angkatan'],$_POST['tahun'],$_POST['nominal']);
 	header("location:index.php?hal=spp");
 } elseif($aksi == "update_kelas"){
 	$db->update_kelas($_POST['id'],$_POST['nama'],$_POST['jurusan'],$_POST['angkatan']);
  	header("location:index.php?hal=kelas");
