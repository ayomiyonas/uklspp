  		...
  		echo '<form role="form" method="POST" action="proses.php?aksi=tambahspp" id="quickForm"  >
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="angkatan" class="form-control" id="exampleInputEmail1" placeholder="Angkatan">
                  </div>
                  <div class="form-group">
  ...
  case "kelas":
        ...
        <form role="form" method="POST" action="proses.php?aksi=tambahkelas" id="quickForm"  >
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label >Jurusan</label>
                    <input type="text" name="jurusan" class="form-control" id="exampleInputPassword1" placeholder="jurusan">
                  </div>
                  <div class="form-group">
                    <label  >Angkatan</label>
                    <input type="text" name="angkatan" class="form-control" id="exampleInputEmail1" placeholder="Angkatan">
              ...
              <form role="form" method="POST" action="proses.php?aksi=tambahsiswa" id="quickForm"  >
                <div class="card-body">
                  ...
                  <select class="form-control" name="angkatan">';
				  	$no = 1;
					foreach($db->tampil_data("kelas","angkatan") as $x){
					echo '
                    <option value="'.$x['id_kelas'].'">'.$x['angkatan'].'</option>
                    ';
					}
					echo '    
                  </select>
